...
#include <linux/slab.h>       // Provides the extern functionality
...
extern char  message[1025];                       ///< **Import** Memory for the string that is passed from userspace

extern short  size_of_message;               ///< **Import** Used to remember the size of the string stored
